...
DEBFULLNAME=v1993 DEBEMAIL=v19930312@gmail.com dch --create --package=linuxmotehook2 --newversion="${MAIN_VERSION}+ci${CIRCLE_BUILD_NUM}" --distribution $(lsb_release -cs) -- 'New upstream commit'
